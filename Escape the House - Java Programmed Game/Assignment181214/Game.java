...
public class Game {
   ...
   private void createRooms() {
    ...
    delivery_room = new Room("in the delivery room", Type.DELIVERY_ROOM);
    ...
    toilets = new Room("in the toilets, take the key for the reception, type 'take key_reception' ", Type.TOILETS);
    
    toilets.addItem(items.get("key_reception"));
    
    reception = new Room("in the reception, take the key for the restaurant, type 'take key_restaurant' ", Type.RECEPTION);
    
    reception.addItem(items.get("key_restaurant"));
    
    waiting_room = new Room("in the waiting room", Type.WAITING_ROOM);
    restaurant = new Room("in the restaurant, take the key to go outside, type 'take key_outside' ", Type.RESTAURANT);
    
    restaurant.addItem(items.get("key_outside"));
   ...
   private void createItems() {
    Item key_reception = new Item("key_reception", "This key can open the reception door...");
    items.put(key_reception.getName().toLowerCase(), key_reception);
    Item key_restaurant = new Item("key_restaurant", "This key can open the restaurant door...");
    items.put(key_restaurant.getName().toLowerCase(), key_restaurant);
    Item key_outside = new Item("key_outside", "This key can open the door to go outside...");
    items.put(key_outside.getName().toLowerCase(), key_outside);
   }
    ...
    */
    ...
    public static boolean hasGot_key(String key_name) {
 
        return !(items.get(key_name) == null);
