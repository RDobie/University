 ...
 
{
    ...
    public boolean goRoom(String direction) {
        ...
        if(nextRoom.getType().equals(Type.OUTSIDE) && !Game.hasGot_key("key_outside"))
        ...
        else  if(nextRoom.getType().equals(Type.RECEPTION) && !Game.hasGot_key("key_reception"))
        ...
        else  if(nextRoom.getType().equals(Type.RESTAURANT) && !Game.hasGot_key("key_restaurant"))
